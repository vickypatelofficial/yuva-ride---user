...
class AppUrl {
  ...
  static const String cancelRideReason =
      '${customerBaseUrl}vehicle_cancel_reason';
  static const String removeRideRequest =
      '${customerBaseUrl}remove_vehicle_request';

  static const String rideDetail = '$baseUrl/customer/cus_ride_detail';
  static const String customerRunningRide =
      '$baseUrl/customer/get_running_ride';
  ...
  static const String allServiceRequest =
      '${customerBaseUrl}all_service_request';

  static const String socketUrl = 'https://yuvaride.techlanditsolutions.com';

  // Ride Sharing APIs
  static const String searchTrips = '$baseUrl/rideshare/customer/search_trips';
  static const String bookSeat = '$baseUrl/rideshare/customer/book_seat';
  static const String bookSeatForOthers =
      '$baseUrl/rideshare/customer/book_seat_for_others';

  static const String signupDtailPrerequities = '$baseUrl/driver/signup_detail';
